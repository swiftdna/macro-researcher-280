...
import walnut_prd_yld from '../data/walnut_iran_prd_yld.json';
...
function Yield() {
    ...
    const options2 = {
      chart: {
        title: "Walnuts Year vs Production and Yield in Iran",
      },
      width: 900,
      height: 500,
      series: {
      ...
      axes: {
        // Adds labels to each axis; they don't have to match the axis names.
        y: {
          Temps: { label: "Production" },
          Daylight: { label: "Yield" },
        },
      },
    };
